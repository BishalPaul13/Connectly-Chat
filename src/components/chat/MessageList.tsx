...
import type { Message, Profile, ConversationWithDetails } from "@/lib/supabase";
...
export function MessageList({ messages, currentUserId, conversation, typingUsers }: MessageListProps) {
