...
export function NewChatDialog({ open, onOpenChange }) {
    ...
    const handleSelectUser = async (selectedUser) => {
        ...
        setCreating(true);
        try {
            const conversation = await createConversation(selectedUser.user_id);
            if (conversation) {
                ...
                toast({
                    ...
                    description: "Please check the browser console (F12) for error details. You may need to run the database migration.",
                    variant: "destructive",
                });
